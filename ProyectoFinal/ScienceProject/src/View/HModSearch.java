 ...
 * @author Brayan
 */
public class HModSearch extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(HModSearch.class.getName());
    ...
    private static HModSearch instance;
    
    public static HModSearch getInstance() {
        if (instance == null) {
            instance = new HModSearch();
        }
        return instance;
    }
