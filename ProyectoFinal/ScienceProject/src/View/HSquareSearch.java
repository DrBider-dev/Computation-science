...
public class HSquareSearch extends javax.swing.JFrame {
    ...
    private void guardarArray(Integer[] array) {
        ...
        fileChooser.setFileFilter(new javax.swing.filechooser.FileNameExtensionFilter("Archivos de Búsqueda Hash Medio Cuadrado", "sqr"));
        ...
        if (option == JFileChooser.APPROVE_OPTION) {
            ...
            if (!file.getName().toLowerCase().endsWith(".sqr")) {
                file = new File(file.getParentFile(), file.getName() + ".sqr");
            }
    ...
    private Integer[] abrirArray() {
        ...
        if (option == JFileChooser.APPROVE_OPTION) {
            ...
            if (!file.getName().toLowerCase().endsWith(".sqr")) {
                JOptionPane.showMessageDialog(this, "El archivo seleccionado no corresponde a una búsqueda Hash Medio Cuadrado.",
