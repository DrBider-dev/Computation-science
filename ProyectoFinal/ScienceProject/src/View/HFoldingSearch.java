...
public class HFoldingSearch extends javax.swing.JFrame {
    ...
    private void guardarArray(Integer[] array) {
        ...
        fileChooser.setFileFilter(new javax.swing.filechooser.FileNameExtensionFilter("Archivos de Búsqueda Hash Plegamiento", "fld"));
        ...
        if (option == JFileChooser.APPROVE_OPTION) {
            ...
            if (!file.getName().toLowerCase().endsWith(".fld")) {
                file = new File(file.getParentFile(), file.getName() + ".fld");
            }
    ...
    private Integer[] abrirArray() {
        ...
        if (option == JFileChooser.APPROVE_OPTION) {
            ...
            if (!file.getName().toLowerCase().endsWith(".fld")) {
                JOptionPane.showMessageDialog(this, "El archivo seleccionado no corresponde a una búsqueda Hash Plegamiento.",
