...
public class MultipleTreeSinUsar extends JFrame {

    public MultipleTreeSinUsar() {
        ...
        clearBtn.addActionListener(e -> treePanel.clear());
    ...
    class TreePanel extends JPanel {
        ...
        private Map<TrieNode, Integer> subtreeSize = new HashMap<>();
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            MultipleTreeSinUsar v = new MultipleTreeSinUsar();
            v.setVisible(true);
        });
    }
